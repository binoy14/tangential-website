    ...
    links?:
      | Array<
          | {
              ...
              link?: { __typename?: "Slug"; current?: string | null | undefined } | null | undefined;
            }
          | null
          | undefined
        >
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getNavigation(
      ...
      data?: GetNavigationQuery | undefined;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GetNavigationQuery>(GetNavigationDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getNavigation"
